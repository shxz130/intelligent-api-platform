...
public class ParamTypeRefGenericSQLConstants {
    ...
    public static final String QUERY_BY_PARAM_AND_GENERIC_TYPE_ID =
            ...
            +"where param_type_id=#{paramTypeId} and generic_type_id=#{genericTypeId}";


    public static final String PERSIST = "insert into "+TABLE_NAME +"(param_type_id,generic_type_id,create_time,update_time)"+
